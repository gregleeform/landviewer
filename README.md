...
### Upcoming graphics annotation roadmap
...
library choices and build-out steps. Phase 3 is now live: the editor supports text,
line, and polygon tools with draggable anchors, inline edits, outline/shadow styling
synced to the toolbar presets, and persistence wired through the application state.
